  ...
  return (
    <div className="m-3 p-3 font-light">
      ...
      <div className="flex justify-center">
        <div className="mx-4">
          Leila
          <AudioElem textContent={"مرحبا، اسمي ليلَى"} speakerName="Leila" />
          <input
        ...
        <div className="mx-4">
          Mehdi
          <AudioElem textContent={"مرحبا، اسمي مَهدِي"} speakerName="Mehdi" />
          <input
            className="radio radio-info mx-2"
            type="radio"
            name="radio-group"
        ...
        <div className="mx-4">
          Nizar
          <AudioElem textContent={"مرحبا، اسمي نزار"} speakerName="Nizar" />
          <input
            className="radio radio-info mx-2"
            type="radio"
            name="radio-group"
        ...
        <div className="mx-4">
          Salma
          <AudioElem textContent={"مرحبا، اسمي سلمَى"} speakerName="Salma" />
          <input
            className="radio radio-info mx-2"
            type="radio"
            name="radio-group"
